#!/usr/bin/env python3
"""
Script to fix document_collaboration_api.py by replacing the broken functions
"""

# Read the original file
with open('tools/document_collaboration_api.py', 'r', encoding='utf-8') as f:
    lines = f.readlines()

# New analyze_document_collaboration function (lines 215-282)
new_analyze_function = '''def analyze_document_collaboration(access_token: str, days: int = 30, max_files: int = 50) -> Dict:
    """
...
# New main function (starting at line 283)
...
# Build the new file
new_lines = (
    lines[:214] +  # Lines 1-214 (before analyze function)
    [new_analyze_function] +  # New analyze function
    [new_main_function]  # New main function
)

# Write the new file
with open('tools/document_collaboration_api.py', 'w', encoding='utf-8') as f:
